...
import br.com.alura.leilao.ui.AtualizadorDeLeiloes.ErroCarregarLeiloesListener;
...
public class ListaLeilaoActivity extends AppCompatActivity {
    ...
    private AtualizadorDeLeiloes atualizarDeLeiloes = new AtualizadorDeLeiloes();
    ...
    private void vaiParaTelaDeLances(Leilao leilao) {
        ...
        Intent vaiParaLancesLeilao = new Intent(
                ListaLeilaoActivity.this, LancesLeilaoActivity.class);
    ...
    protected void onResume() {
        ...
        super.onResume();
        atualizarDeLeiloes.buscaLeiloes(client, adapter, new ErroCarregarLeiloesListener() {
            @Override

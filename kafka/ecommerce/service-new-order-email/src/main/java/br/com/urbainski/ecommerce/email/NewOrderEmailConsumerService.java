...
public class NewOrderEmailConsumerService extends AbstractDefaultConsumer<String, Order> {

    private static final Logger log = LoggerFactory.getLogger(NewOrderEmailConsumerService.class);
    ...
    public void processarRecord(ConsumerRecord<String, MyMessage<Order>> record) {
        ...
        var emailMessage = String.format("A venda da order: %s está sendo processada, aguarde...", order.getOrderId());
    ...
    public String getGroupId() {
        return NewOrderEmailConsumerService.class.getSimpleName();
    }
